      ...
      {trainingData.map((training) => (
        ...
        >
          ...
          >
            ...
            <div className="relative text-center flex items-center justify-center text-primary w-full py-2.5 bg-white border-t duration-300 group-hover:text-white gap-3 overflow-hidden">
